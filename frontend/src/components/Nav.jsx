                ...
                >
                  <div className="text-sm text-gray-800">
                    ...
                    >
                      ...
                      {responsiveOpen && (
                        <div className="absolute top-0 left-full ml-2 w-52 bg-white rounded-xl shadow-xl py-2 border border-gray-100 z-50">
                          <Link to="/products/responsive/about-responsive" className="block px-5 py-2 hover:bg-red-50">About Responsive</Link>
                          ...
                          <Link to="/products/responsive/download-center" className="block px-5 py-2 hover:bg-red-50">Download Center</Link>
                        </div>
                      )}
                    </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white shadow-xl fixed top-16 left-0 w-full z-50 border-t">
          <nav className="px-6 py-8 space-y-1 text-base">
                ...
                <div className="pl-6 space-y-1 mt-1">
                  ...
                  <div>
                    ...
                    {mobileResponsiveOpen && (
                      <div className="pl-6 space-y-1">
                        <Link to="/products/responsive/about-responsive" className="block py-2.5 px-4 hover:bg-red-50 rounded-xl" onClick={() => setMobileOpen(false)}>About Responsive</Link>
                        ...
                        <Link to="/products/responsive/download-center" className="block py-2.5 px-4 hover:bg-red-50 rounded-xl" onClick={() => setMobileOpen(false)}>Download Center</Link>
                      </div>
                    )}
                  </div>
            ...
            <Link 
              to="/contact" 
              className="block text-center mt-6 bg-red-600 text-white py-3 px-6 rounded-2xl font-medium hover:bg-red-700"
