              ...
              <div className="grid grid-cols-3 gap-3">
                {product.images.map((img, idx) => (
                  <button
                    ...
                    className={`rounded-lg overflow-hidden border-2 transition ${activeImageIndex === idx ? 'border-red-600 shadow-md' : 'border-gray-200'
                      }`}
                  >
                    <img
                      src={img}
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-800 py-16 px-6">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg mb-8 text-white/90">
              Our experts are here to guide you through our product range
            </p>

            <Link
              to="/contact"
              className="inline-block bg-white text-red-600 px-8 py-3 rounded-full font-semibold hover:shadow-lg transition"
            >
              Contact Our Team
            </Link>
          </div>
